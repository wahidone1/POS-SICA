...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 08 Jul 2024 pada 17.03
...
CREATE TABLE `nota` (
  ...
  `code_nota` varchar(255) NOT NULL,
...
--
-- Struktur dari tabel `penjualan1`
--
...
--
-- AUTO_INCREMENT untuk tabel `penjualan1`
--
ALTER TABLE `penjualan1`
  MODIFY `id_penjualan` int(11) NOT NULL AUTO_INCREMENT;
